...
namespace War
{
    public partial class WarMainForm : Form
    {
        ...
        private CardHand m_Deck = new CardHand();
        private CardHand m_Hand1 = new CardHand();      // player one's hand  
        private CardHand m_Hand2 = new CardHand();      // player two's hand
        private CardHand m_MiddlePile = new CardHand(); // the pile of cards in the middle during wars!
        private CardHand m_LastWinnings = new CardHand();
        ...
        private bool ThrowReal(ref int recursionCount)
        {
            ...
            PlayingCard card1 = m_Hand1.DrawFromTop();
            PlayingCard card2 = m_Hand2.DrawFromTop();
